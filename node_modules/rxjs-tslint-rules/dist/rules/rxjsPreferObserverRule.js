        ...
        propertyAccessExpressions.forEach(function (node) {
            ...
            if (tsutils.isCallExpression(callExpression)) {
                ...
                if (util_1.couldBeType(type, "Observable")) {
                    ...
                    switch (name_1) {
                        case "pipe":
                            failures.push.apply(failures, tslib_1.__spreadArray([], tslib_1.__read(_this.validatePipe(sourceFile, typeChecker, callExpression))));
                            break;
                        case "subscribe":
                            failures.push.apply(failures, tslib_1.__spreadArray([], tslib_1.__read(_this.validateArgs(sourceFile, typeChecker, callExpression))));
                            break;
                        default:
